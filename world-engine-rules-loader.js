...
六级层级（每个维度通用，从低到高）：天怒人怨 → 声名狼藉 → 默默无闻 → 小有名气 → 受人尊敬 → 万众敬仰
...
五、规则细节
- 【反杀回升机制】通过反杀复仇团体获得的声誉提升，默认作用于同道之间（封顶"小有名气"）；若反杀对象为恶贯满盈的团体，则同时提升市井口碑与草莽地位。
...
- 已终结的条目会保留20轮备忘后自动清除。
- 反杀后{{user}}声誉可回升，但最高只能达到"小有名气"（若声誉模块启用）。
- 对应的冲突型事件链同步标记为已终结。
